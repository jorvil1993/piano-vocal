  ...
  versions: {
    official: {
      ...
      measures: [
        ...
        { id: 31, chords: [{ chord: 'Re', beats: 4 }] },
        { id: 32, chords: [{ chord: 'La#dim', beats: 4 }] },
        // Fila 9 (Screenshot 2)
        { id: 33, chords: [{ chord: 'Sol', beats: 4 }], lyric: "Mi lanza atravesaba tu costado" },
        { id: 34, chords: [{ chord: 'Lasus4', beats: 2 }, { chord: 'La', beats: 2 }] },
        { id: 35, chords: [{ chord: 'Fa#m', beats: 4 }], lyric: "Todo un héroe y en silencio, eras tú" },
        { id: 36, chords: [{ chord: 'Sim', beats: 4 }], lyric: "Mi salvador" },
        // Fila 10
        ...
        { id: 44, chords: [{ chord: 'Do', beats: 2 }, { chord: 'Si7', beats: 2 }], lyric: "Amor que nunca muere" },
        // Fila 12
        { id: 45, chords: [{ chord: 'Mim7', beats: 4 }], lyric: "Amor que entrega todo hasta la eternidad, oh-oh" },
        { id: 46, chords: [{ chord: 'La', beats: 4 }] },
        { id: 47, chords: [{ chord: 'Re', beats: 4 }], section: "Interludio" },
        { id: 48, chords: [{ chord: 'La#dim', beats: 4 }] },
        // Fila 13
        { id: 49, chords: [{ chord: 'Sol', beats: 4 }], section: "Estrofa 2", lyric: "Todo un héroe y en silencio, eras tú" },
        { id: 50, chords: [{ chord: 'Lasus4', beats: 2 }, { chord: 'La', beats: 2 }] },
        { id: 51, chords: [{ chord: 'Fa#m', beats: 4 }], lyric: "Mi salvador" },
        { id: 52, chords: [{ chord: 'Sim', beats: 4 }], lyric: "Te entregaste por amor" },
        // Fila 14
        ...
        // Fila 16
        { id: 61, chords: [{ chord: 'Mim7', beats: 4 }], lyric: "Amor que entrega todo hasta la eternidad, oh-oh" },
        { id: 62, chords: [{ chord: 'La', beats: 4 }] },
        { id: 63, chords: [{ chord: 'Fa#', beats: 4 }], section: "Puente", lyric: "Hasta el último suspiro" },
        { id: 64, chords: [{ chord: 'Sim', beats: 4 }], lyric: "Sin renunciar a este castigo" },
        // Fila 17
        { id: 65, chords: [{ chord: 'Sol#dim', beats: 4 }], lyric: "Condenado por amar" },
        { id: 66, chords: [{ chord: 'Solm', beats: 4 }], lyric: "Hasta morir, hasta el final" },
        { id: 67, chords: [{ chord: null, beats: 4 }], lyric: "Por darle a mi alma libertad" },
        ...
        { id: 70, chords: [{ chord: 'Sol', beats: 4 }], lyric: "Y yo sin merecerlo" },
